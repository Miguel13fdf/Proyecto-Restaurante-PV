...
import CustomElements.Menu.ComponentResizer;
...
/**
 * Clase que representa la barra de título de una ventana Swing.
 * Esta clase extiende la clase "JComponent" y contiene botones para cerrar, minimizar y maximizar la ventana.
*/
...
public class TitleBar extends JComponent {
    ...
    /**
     *  Este método registra un "ComponentResizer" para permitir que la ventana se pueda redimensionar mediante el mouse,
     * y también configura los eventos del mouse para permitir que la ventana se pueda mover arrastrándola con el ratón.
     */
    ...
    /**
     * se utiliza para representar los botones de la barra de título. 
     * Este botón tiene una apariencia circular con un fondo de color y un tamaño prefijado. 
     * El método "paintComponent()" se utiliza para dibujar el botón y hacerlo parecer redondo.
     */
