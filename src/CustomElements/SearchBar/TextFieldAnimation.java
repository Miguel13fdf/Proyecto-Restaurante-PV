...
public class TextFieldAnimation extends JTextField {
    ...
    public TextFieldAnimation() {
        ...
        iconSearch = new ImageIcon(getClass().getResource("/CustomElements/SearchBar/search.png"));
        iconClose = new ImageIcon(getClass().getResource("/CustomElements/SearchBar/close.png"));
        iconLoading = new ImageIcon(getClass().getResource("/CustomElements/SearchBar/loading.gif"));
