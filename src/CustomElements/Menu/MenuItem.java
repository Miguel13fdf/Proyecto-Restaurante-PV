...
/**
 * representa un elemento del menú y contiene un botón con el texto del elemento
 * y una lista de subelementos (si tiene). 
 * La clase Item es la clase que representa el botón en sí, con su color, icono y animaciones.
 * Se utiliza un MigLayout para que los botones se ajusten automáticamente al tamaño del JPanel
 */
