...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    // Este método se utiliza para instalar y configurar la interfaz de usuario de un JComboBox.
    @Override
    public void installUI(JComponent jc) {
        ...
        comboBox.addPopupMenuListener(new PopupMenuListener() {
            ...
            public void popupMenuWillBecomeInvisible(PopupMenuEvent pme) {
                // Color de la flecha cuando se a seleccionado un elemento
                arrowButton.setBackground(new Color(150, 150, 150));
            }

            @Override
            public void popupMenuCanceled(PopupMenuEvent pme) {
                // Color de la flecha cuando se cancela
                arrowButton.setBackground(new Color(255, 201, 80));
            }
        });
        // Se utiliza para proporcionar funcionalidad de autocompletado de texto en el JComboBox.
        AutoCompleteDecorator.decorate(comboBox);
        // Color del autocompletado
        txt.setSelectionColor(new Color(119, 119, 119));
        ...
        return new ListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList jlist, Object e, int i, boolean bln, boolean bln1) {
                ...
                if (bln) {
                    ...
                    // Color del fondo cuando el mouse pasa por encima de un elemento de las opciones
                    label.setBackground(new Color(240, 240, 240));
                    // Color del texto cuando el mouse pasa por encima de un elemento de las opciones
